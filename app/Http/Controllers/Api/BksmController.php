...
class BksmController extends Controller
{
...
// Buat paginasi manual pada koleksi lembagaList
    ...
    public function store(Request $request)
    {
        try {
            ...
            $existingRecord = Bksm::where('tahun_id', $request->tahun_id)
     ...
     */
    public function show(Bksm $bksm)
    {
        //
    }
     ...
     */
    public function update(Request $request, Bksm $bksm)
    {
    }

    public function updateFile(Request $request, Bksm $bksm)
    {
        try {
            ...
            if ($bksm->path && Storage::disk('public')->exists($bksm->path)) {
                Storage::disk('public')->delete($bksm->path);
            }
     ...
     */
    public function destroy(Bksm $bksm)
    {
        try {
    ...
    public function download(Bksm $bksm)
    {
        try {
            // 1. Cari data laporan berdasarkan ID
            $filePath = $bksm->path;
            $fileName = $bksm->name_file;
